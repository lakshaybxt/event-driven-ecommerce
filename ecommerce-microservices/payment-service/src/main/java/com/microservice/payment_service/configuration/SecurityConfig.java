...
import com.microservice.payment_service.security.JwtSecurityFilter;
import com.microservice.payment_service.service.JwtService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtSecurityFilter jwtSecurityFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/payment/public/**").hasAnyRole("CUSTOMER", "ADMIN")
